/*
  ...
  linear Hall effect sensors. This code is meant to be used for
  ...
  for (int i = 0; i<3; i++){
    ...
    for (int j = 0; j<N; j++){
      ...
      if(data <= trigger_values[j]){
        ...
        // If the delta isn't 0, map delta to velocity
        if (delta>0){
